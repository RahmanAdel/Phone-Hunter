...
//search input using enter key handler
document
...
const displayPhoneDetails = (phone) => {
  ...
  <p>Storage: ${
    phone.mainFeatures ? phone.mainFeatures.storage : 'No Storage Supported'
  }</p>
  <p>Others: ${phone.others ? phone.others : 'Bluetooth Not Supported'}</p>
  <p>Sensor: ${
